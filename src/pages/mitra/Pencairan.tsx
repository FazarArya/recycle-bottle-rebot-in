  ...
  const simulateTransaction = (success: boolean) => {
    if (success) {
      ...
      toast({
        ...
        description: "Terima kasih telah menukar komisi GreenCoin Anda di T-Mart",
      });
    } else {
        ...
        {!barcodeGenerated ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Masukkan jumlah komisi GreenCoin yang ingin dicairkan
              </CardDescription>
            </CardHeader>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-foreground">
                    ...
                    <ol className="list-decimal list-inside space-y-1">
                      <li>Masukkan jumlah komisi yang ingin dicairkan</li>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Terima kasih atas kerjasama Anda sebagai Mitra ReBot.In!
                  </p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Yuk coba sekali lagi! Biarkan penukaran komisi Anda lebih lancar
                  </p>
                </div>
                <Button 
                  onClick={() => {
              ...
              <div className="bg-accent/30 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-foreground">
                    ...
                    <p>Barcode ini berlaku selama 30 menit. Segera kunjungi T-Mart terdekat untuk mencairkan komisi Anda.</p>
                  </div>
                </div>
              </div>
